...
const Contact = () => {
  ...
  <div>
    ...
    <p className="text-gray-300 text-sm">
      <span className="font-semibold text-primary">Monday - Friday:</span> 9:00 AM - 6:00 PM<br />
      <span className="font-semibold text-primary">Saturday:</span> 10:00 AM - 4:00 PM<br />
